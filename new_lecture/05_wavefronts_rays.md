...
**Source decks:** `314_2023_4_seismic_waves.pdf` (slides 16–27), `314_2023_5_seismic_waves_II.pdf` (slides 4–17)
**Relevant slides for this lecture:** Huygens' principle (slides 16/4), isotropic vs. heterogeneous wavefronts (slides 17/5), refraction geometry (slides 18–20/6–8), Snell's law geometric derivation (slides 19/7), Fermat's principle (slides 25–26/15–16), critical refraction preview (slides 27/17).
**Slides deferred to Lecture 6 (Waves at Boundaries):** Reflection (slides 21/9), mode conversion (slides 23–24/11–12), diffraction (slides 13–14 of deck II).

### Copyright Inventory

| Slide | Content | Source | Copyright | Action |
|-------|---------|--------|-----------|--------|
| 16/4 | Huygens principle diagram | Likely textbook | ❌ | [PYTHON-REGEN] |
| 17/5 | Isotropic vs. heterogeneous wavefronts | Likely textbook | ❌ | [PYTHON-REGEN] |
| 18/6 | Seismic refraction schematic | Simple diagram, likely instructor | ⚠️ | [PYTHON-REGEN] |
| 19/7 | Snell's law geometric derivation (Fig. 6.17 Cambridge) | Cambridge University Press | ❌ | [PYTHON-REGEN] |
| 20/8 | Snell's law summary diagram | Instructor-generated | ✅ | [PYTHON-REGEN] for consistency |
| 25/15 | Fermat's principle — multiple paths + geometry | Cambridge University Press | ❌ | [PYTHON-REGEN] |
| 26/16 | Fermat's principle — travel time minimization | Cambridge University Press | ❌ | [PYTHON-REGEN] |
| 27/17 | Critical refraction | Instructor-generated | ✅ | Deferred to Lecture 6 |
